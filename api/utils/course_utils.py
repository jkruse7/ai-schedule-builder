...
def ask_gemini_to_generate_questions(all_courses: dict[str, str], courses_taken:dict[str, str]):
    ...
    total_courses = str(all) # convert to string all classes
...
def get_courses_by_subject(major: str):
    ...
    formatted = format_courses(major_courses.courses) # list of dictionaries
...
def includeRequirements(courses_taken: list[dict], classes_selected: list[dict]):
    ...
    for classes in doc['Requirements']:
        ...
        if is_in_class_taken(courses_taken, class_list[1]): # if it is not in classes taken
...
if __name__ == "__main__":
    ...
    courses_taken = [{"course_id": "105699", "course_key": "0449", "course_number": "0449", "course_title": "INTRODUCTION TO SYSTEMS SOFTWARE", "subject_code": "CS"}, {"subject_code": "CS", "course_number": "0004", "course_id": "105609", "course_title": "INTRODUCTION TO COMPUTER PROGRAMMING-BASIC", "course_key": "0004"}, {"subject_code": "CS", "course_number": "1501", "course_id": "105761", "course_title": "ALGORITHMS AND DATA STRUCTURES 2", "course_key": "1501"}]
    ...
    #print(includeRequirements(courses_taken, classes_selected))
